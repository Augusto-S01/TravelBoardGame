    ...
    <main>
        ...
        <?php
            ...
            if(isset($_SESSION['usuario'])){                
                ...
                echo('<div class="jogar"><a href="cadastro.php"><input class="jogar__botao" type="button" value="faça seu cadastro para jogar"></a><a href="login.php"><h3 class="jogar__login">Já possui cadastro?</h3></a></div>');
            }
        ?>
